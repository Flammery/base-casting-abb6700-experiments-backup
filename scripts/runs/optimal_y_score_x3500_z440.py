...
import window_conf_export as base  # noqa: E402
import optimal_y_selection as optimal  # noqa: E402
...
def enrich_candidate_row(model_y: float, angle: int, row: dict, path: base.PathResult) -> dict:
    return {
        ...
        "score_max_abs_world_x": optimal.score_max_abs_world_x(path),
        **row,
    }
...
def main() -> None:
    ...
    summary = {
        ...
        "tie_breakers": ["score_max_abs_world_x"],
